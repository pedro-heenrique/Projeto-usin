        ...
        <div class="card-body">
            <form action="/" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="automovel" name="automovel" placeholder="Digite o nome do Automóvel">
                </div>
                <div class="form-group">
                    <label for="endereco_origem">Endereço de origem:</label>
                    <input type="text" class="form-control" id="endereco_origem" name="endereco_origem" placeholder="Digite o endereço de origem">
                </div>
                <div class="form-group">
                    <label for="endereco_entrega">Endereço de entrega:</label>
                    <input type="text" class="form-control" id="endereco_entrega" name="endereco_entrega" placeholder="Digite o endereço de entrega">
                </div>
